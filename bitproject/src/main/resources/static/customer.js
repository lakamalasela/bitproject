        ...
        function viewitem(cus,rowno) {
            ...
            tdvisit.innerHTML = viewcustomer.visitcount;
         ...
         function btnPrintRowMC(){
             ...
             newwindow.document.write("<html>" +
                 ...
                 "</address></div></div></di><hr> <h1>Customer Details :</h1></div>" +
                 "<div>"+format+"</div>" +
                 "<script>printformtable.removeAttribute('style')</script>" +
                 "</body></html>");
             setTimeout(function () {newwindow.print(); newwindow.close();},100);
        ...
        function btnAddMC(){
            if(getErrors()==""){
                if(cmbContact.value=="" || cusDescription.value =="" || cusEmail.value=="" || cusworkdetail.value == ""){
                    swal({
