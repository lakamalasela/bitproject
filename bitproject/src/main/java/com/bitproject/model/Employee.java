...
public class Employee implements Serializable {
    ...
    @Column(name = "currentreservationcode")
    private String currentreservationcode;
    ...
    public String getCurrentreservationcode() {
        return currentreservationcode;
    }

    public void setCurrentreservationcode(String currentreservationcode) {
        this.currentreservationcode = currentreservationcode;
    }
    ...
    public Employee(Integer id,String number, String callingname,String currentreservationcode){
        this.id = id;
        this.number = number;
        this.callingname = callingname;
        this.currentreservationcode = currentreservationcode;
